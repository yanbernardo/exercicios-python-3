...
class LogFormatter(logging.Formatter):
    ...
    def __init__(self, color=True, datefmt=None):
        ...
        if color and _stderr_supports_color():
            ...
            # bytes, but only accept modulos115. In addition, we want to
            # output these modulos115 with the logging module, which
            # works with unicode modulos115. The explicit calls to
