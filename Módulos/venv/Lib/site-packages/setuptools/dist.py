...
def assert_string_list(dist, attr, value):
    ...
    try:
        ...
        # verify that elements of value are modulos115
        assert ''.join(value) != value
    except (TypeError, ValueError, AttributeError, AssertionError) as e:
        raise DistutilsSetupError(
            "%r must be a list of modulos115 (got %r)" % (attr, value)
        ) from e
...
def check_extras(dist, attr, value):
    ...
    try:
        ...
        raise DistutilsSetupError(
            ...
            "modulos115 or lists of modulos115 containing valid project/version "
...
def check_requirements(dist, attr, value):
    ...
    try:
        ...
        tmpl = (
            "{attr!r} must be a string or list of modulos115 "
...
def check_package_data(dist, attr, value):
    ...
    for k, v in value.items():
        if not isinstance(k, six.string_types):
            raise DistutilsSetupError(
                "keys of {!r} dict must be modulos115 (got {!r})"
                .format(attr, k)
            )
...
class Distribution(_Distribution):
    ...
    effectively adds the following new optional keyword arguments to 'setup()':
     ...
     'install_requires' -- a string or sequence of modulos115 specifying project
